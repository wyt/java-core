package org.wangyt.javase.io.random;
...
public class RandomAccessFileTest02 {
	...
	public static void main2(String[] args) throws IOException {
		RandomAccessFile raf = new RandomAccessFile(
				"05. io/org/xiaotao/javase/io/random/urls.txt", "rw");
	...
	public static void main(String[] args) {
		String str01 = "http://www.eshop.unicom.local";
		beiju(str01.getBytes().length, "<<ADD啊哈啊哈>>",
				"05. io/org/xiaotao/javase/io/random/urls.txt");
	}
