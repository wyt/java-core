 ...
 * 
 * 它们可被分为四种类型，整型、浮点型、char型和boolean型，即四类八种。
 * 
...
public class PrimitiveType
{
    public static void main(String[] args)
    {
        ...
        System.out.println("POSITIVE_INFINITY：S=0 E=255 M=0  0x7f800000  运行结果：" + Float.intBitsToFloat(0x7f800000));
        // NEGATIVE_INFINITY，负无穷大
        System.out.println("NEGATIVE_INFINITY：S=0 E=255 M=0  0xff800000  运行结果：" + Float.intBitsToFloat(0xff800000));
        // 双精度浮点数同理可得
